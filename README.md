<h1 style="font-size: 50px; text-align: center;"> <b>Curriculum vitae</b></h1>
<h2 style="text-align: center;">Nodejs RESTFUL API</h2>
...
```
- git clone https://github.com/Toxiicsab/CV-nodejs.git
